...
<!-- Provide a clear, detailed description of your contribution, issue, or idea -->



### Why is this important or valuable?
<!-- Explain the benefit to the project, community, or learners -->
...
<!-- e.g., challenges/beginner/hello-world/, README.md, scripts/validate.py -->
...
**Frameworks/Tools you know:**
<!-- e.g., React, Django, Node.js, Docker, Git, etc. -->
...
<!-- Describe your implementation strategy, architecture, or solution approach -->



### Technical requirements or dependencies:
<!-- List any tools, libraries, or setup needed -->
...
<!-- How would you like to communicate? GitHub comments, Discord, etc. -->
...
<!-- Any helpful documentation, tutorials, or inspiration -->



### Fun fact or personal note:
<!-- Optional: Share something interesting about yourself or why this contribution matters to you! -->
